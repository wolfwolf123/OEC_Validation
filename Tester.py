...
class Tester(unittest.TestCase):
    ...
    def test_find_errors(self):
        ...
        Trend_Handler.find_product_trends(Main.database, Main.product_codes)      
            
        Trend_Handler.find_trends(Main.country_codes,Main.product_codes,True)
            
        Trend_Handler.find_trends(Main.country_codes,Main.product_codes,False)
...
#  
    def test_find_interesting_trends(self):
       ...
       (('14710811-five_year_trend$48000001.0', 0.074074), ('14710811-five_year_trend|afmar~Import$833333.333333', -1.0), 
        ('14710811-five_year_trend|afmdg~Import$833333.333333', -1.0), ('14710811-five_year_trend|aslao~Import$833333.333333', -1.0),
        ('14710811-five_year_trend|asnpl~Import$833333.333333', -1.0), ('14710811-five_year_trend|eumlt~Import$2500000.0', 9.0), 
        ('14710811-five_year_trend|namex~Import$833333.333333', -1.0), ('14710811-five_year_trend|nausa~Export$40500000.0', 0.225), 
        ('14710811-five_year_trend|ocnru~Import$1833333.33333', -0.5), ('14710811-long_trend$48000001.0', 0.074074), 
        ('14710811-long_trend|afmar~Import$833333.333333', -1.0), ('14710811-long_trend|afmdg~Import$833333.333333', -1.0), 
        ('14710811-long_trend|aslao~Import$833333.333333', -1.0), ('14710811-long_trend|asnpl~Import$833333.333333', -1.0), 
        ('14710811-long_trend|eumlt~Import$2500000.0', 9.0), ('14710811-long_trend|namex~Import$833333.333333', -1.0), 
        ('14710811-long_trend|nausa~Export$40500000.0', 0.225), ('14710811-long_trend|ocnru~Import$1833333.33333', -0.5),
        ('14710811-one_year_trend$80000001.0', 0.072289), ('14710811-one_year_trend|afmar~Import$500000.0', -1.0), 
        ('14710811-one_year_trend|afmdg~Import$500000.0', -1.0), ('14710811-one_year_trend|aslao~Import$500000.0', -1.0), 
        ('14710811-one_year_trend|asnpl~Import$500000.0', -1.0), ('14710811-one_year_trend|eumlt~Import$5500000.0', 9.0), 
        ('14710811-one_year_trend|namex~Import$500000.0', -1.0), ('14710811-one_year_trend|nausa~Export$41500000.0', 0.225), 
        ('14710811-one_year_trend|ocnru~Import$1500000.0', -0.5), ('14710811-three_year_trend$53333334.3333', 0.07362), 
        ('14710811-three_year_trend|afmar~Import$750000.0', -1.0), ('14710811-three_year_trend|afmdg~Import$750000.0', -1.0), 
        ('14710811-three_year_trend|aslao~Import$750000.0', -1.0), ('14710811-three_year_trend|asnpl~Import$750000.0', -1.0), 
        ('14710811-three_year_trend|eumlt~Import$3250000.0', 9.0), ('14710811-three_year_trend|namex~Import$750000.0', -1.0), 
        ('14710811-three_year_trend|nausa~Export$40750000.0', 0.225), ('14710811-three_year_trend|ocnru~Import$1750000.0', -0.5)))
